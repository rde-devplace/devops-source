...
class JoperatorApplicationTestsBK {
    ...
    public void testStatefulset() {
        ...
        containers.add(realIdeResourceGenerator.vscodeServerContainer(ideConfig, "vscodeserver", "vscode-server:1.0", 8443, isVscode, isGit, "kube-proxy.amdp-dev.skamdp.org", "path"));
